...
function i_webgl_preview()
{
    ...
    this.on = function(event_name, event_handler)
    {
        ...
        return i_webgl_preview_bee.on(event_name, event_handler);
    };
    ...
    this.run = function()
    {
        ...
        return i_webgl_preview_bee.run();
    };
    ...
    this.quit = function()
    {
        ...
        return i_webgl_preview_bee.close();
    };
    ...
    this.error = function()
    {
        ...
        return i_webgl_preview_bee.error;
    };
    ...
    this.init = function()
    {
        ...
        i_webgl_preview_bee.gui.position.top(20);
        i_webgl_preview_bee.gui.size.width(900);
        i_webgl_preview_bee.gui.size.height(600);
