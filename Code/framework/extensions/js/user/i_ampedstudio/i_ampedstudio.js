...
function i_ampedstudio()
{
    ...
    this.init = function()
    {
        ...
        i_ampedstudio_bee.gui.position.left(280);
        i_ampedstudio_bee.gui.position.top(32);
        i_ampedstudio_bee.gui.size.width(1660);
        i_ampedstudio_bee.gui.size.height(960);
