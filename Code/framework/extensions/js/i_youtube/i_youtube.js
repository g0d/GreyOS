/*
    ...
    GreyOS Inc. - Integrated YouTube extension
    ...
    function new_bees()
    {
        ...
        function player()
        {
            ...
            this.init = function(__title, video_id)
            {
                ...
                var __random_id = pythia.generate();

                config.video_tag = 'i_youtube_player_' + __random_id;
            ...
            this.ghost_icon = function()
            {
                ...
                var __hive = vulcan.objects.by_id('ghost_bee');
        ...
        function recorder()
        {
            ...
            this.init = function()
            {
                ...
                config.rec_tag = 'i_youtube_recorder_' + __random_id;
