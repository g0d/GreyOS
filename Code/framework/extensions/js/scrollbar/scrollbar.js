/*
    ...
    GreyOS Inc. - Scrollbar for GreyOS
    
    File name: scrollbar.js (Version: 1.0)
    Description: This file contains the Scrollbar extension.
...
function scrollbar()
{
    ...
    function utilities()
    {
        ...
        this.draw = function(id)
        {
            ...
            // Apply Scroll Bar on the left side
            else
    ...
    this.destroy = function(container_id)
    {
        ...
        // Code had no meaning... Please explain!
