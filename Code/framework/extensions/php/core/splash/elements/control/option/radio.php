<?php
    /*
        ...
        File name: radio.php (Version: 4.6)
    ...
    */
    ...
    class RADIO extends OPTION
    {
        ...
        public function Show($attributes, $events = null)
        {
            ...
            {
                HELPERS::Error('Radio', 20);

                return false;
            }

            $html_tag = '<input type="radio" name="' . $attributes['name'] . '" value="' . $attributes['value'] . '" ';
