/*
    GreyOS Inc. - Test App (Alternative 3) for Cloud Edit
    
    File name: test_app_alt3.js (Version: 1.0)
...
function test_app()
{
    ...
    this.init = function()
    {
        ...
        test_app_bee.settings.data.window.labels.title('GreyOS :: Test App (Alternative 3)');
        test_app_bee.settings.data.window.labels.status_bar('My 4rth truly integrated app!');
        test_app_bee.settings.data.window.content('This app tests opacity FX and variance with fade FX relative to other windows!');
